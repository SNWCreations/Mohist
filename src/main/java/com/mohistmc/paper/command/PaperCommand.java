package com.mohistmc.paper.command;

import com.mohistmc.paper.command.subcommands.*;
...
public final class PaperCommand extends Command {
    ...
    private static final Map<String, PaperSubcommand> SUBCOMMANDS = Util.make(() -> {
        ...
        // commands.put(Set.of("reload"), new ReloadCommand()); // Mohist+ - We don't support Paper config yet
        // commands.put(Set.of("version"), new VersionCommand()); // Mohist+ - We have our own version command
        // commands.put(Set.of("dumpplugins"), new DumpPluginsCommand()); // Mohist+ - We don't support Paper plugins yet
        // commands.put(Set.of("fixlight"), new FixLightCommand()); // Mohist+ - We don't have Starlight engine integrated, and it is no longer necessary
        // commands.put(Set.of("debug", "chunkinfo", "holderinfo"), new ChunkDebugCommand()); // Mohist+ - We don't rework chunk system
        // commands.put(Set.of("syncloadinfo"), new SyncLoadInfoCommand()); // Mohist+ - We don't have things needed to support sync load info yet
        commands.put(Set.of("dumpitem"), new DumpItemCommand());
        // commands.put(Set.of("mobcaps", "playermobcaps"), new MobcapsCommand()); // Mohist+ - We don't rework mob spawning
