package com.mohistmc.paper.command.subcommands;

import com.google.common.collect.Maps;
import com.mohistmc.paper.command.CommandUtil;
import com.mohistmc.paper.command.PaperSubcommand;
    ...
    private void listEntities(final CommandSender sender, final String[] args) {
        ...
        if ("list".equals(args[0].toLowerCase(Locale.ENGLISH))) {
            ...
            world.getAllEntities().forEach(e -> {
                ...
                if (!chunkProviderServer.isPositionTicking(e) || (e instanceof net.minecraft.world.entity.Marker /*&& !world.paperConfig().entities.markers.tick*/)) { // Configurable marker ticking // Mohist+ - We don't support Paper config yet
