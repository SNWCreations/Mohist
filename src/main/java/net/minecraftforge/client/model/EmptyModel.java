...
public class EmptyModel extends SimpleUnbakedGeometry<EmptyModel>
{
    ...
    private static class Baked extends SimpleBakedModel
    {
        ...
        public Baked()
        {
            super(List.of(), Map.of(), false, false, false, UnitTextureAtlasSprite.INSTANCE, ItemTransforms.NO_TRANSFORMS, ItemOverrides.EMPTY/*, RenderTypeGroup.EMPTY, RenderTypeGroup.EMPTY*/); // Mohist+ - We don't patch client, just make it compile
        }
